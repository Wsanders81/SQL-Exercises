...
--* SELECT app_name FROM analytics WITH id = 1880;

--? Find the ID and app name for all apps that were last updated on August 01, 2018.

--* I received an encoding error when attempting to query the db on this one. 

-- playstore=# SELECT id, app_name FROM analytics WHERE last_updated = '2018-08-01'
-- playstore-# ;
-- ERROR:  character with byte sequence 0xf0 0x9f 0x90 0xac in encoding "UTF8" has no equivalent in encoding "WIN1252"     g "WIN1252"
...
--* SELECT * FROM analytics WHERE price BETWEEN 0.10 AND 
--* 1 ORDER BY reviews LIMIT 10; 
...
--* SELECT app_name FROM analytics ORDER BY last_updated 
--* LIMIT 1; 
